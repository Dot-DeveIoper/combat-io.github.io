...
(function (e) {
  ...
  function update() {
    ...
    if (leaderboard[1]) {
      document.getElementById("players").innerHTML += "<div style='float:left;'>" + leaderboard[1].name + "</div><div style='float: right;color:gold;'>" + gold(1) + "</div>" + "<br>";
    }
    if (leaderboard[2]) {
      document.getElementById("players").innerHTML += "<div style='float:left;'>" + leaderboard[2].name + "</div><div style='float: right;color:gold;'>" + gold(2) + "</div>" + "<br>";
    }
    if (leaderboard[3]) {
      document.getElementById("players").innerHTML += "<div style='float:left;'>" + leaderboard[3].name + "</div><div style='float: right;color:gold;'>" + gold(3) + "</div>" + "<br>";
    }
    if (leaderboard[4]) {
      document.getElementById("players").innerHTML += "<div style='float:left;'>" + leaderboard[4].name + "</div><div style='float: right;color:gold;'>" + gold(4) + "</div>" + "<br>";
    }
    if (leaderboard[5]) {
      document.getElementById("players").innerHTML += "<div style='float:left;'>" + "And " + leaderboard.length - 5 + "more...";
    }
